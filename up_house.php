            ...
            <form action="upload_photos_logement.php" method="post" class="register" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="register-left-grid">
                    ...
                    <div>
                        ...
                        <textarea name="descriptionSuccincte" rows="3" cols="45" maxlenght="120" title="120 caractères maximum" required><?php if(isset($save['descriptionSuccincte'])){echo $save['descriptionSuccincte'];} ?></textarea>
                    </div>       
