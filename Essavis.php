...
?>
<p><strong><?php echo htmlspecialchars($donnees['pseudo']); ?></strong> le <?php echo $donnees['dateAjout']; ?> :</p><?php if (isadmin()) {echo('<a href="suppression-commentaire.php?idCommentaire='.$donnees['id'].'&idLogement='.$idLogement.'">Supprimer</a>');}?>
